...
// INICIO - Configuración de la tabla de regiones operativas
var tabla_regiones_operativas = $(ID_TABLA_REGIONES_OPERATIVAS).DataTable({ 
 ...
 .on('click', 'tr', function() {
	 rowNode = this;
	 rowElement = tabla_regiones_operativas.row(this).data();
	 idElement = tabla_regiones_operativas.row(this).data()[0];
});
