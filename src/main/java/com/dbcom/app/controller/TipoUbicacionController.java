...
import com.dbcom.app.service.TipoUbicacionService;
...
@Slf4j
@Controller
public final class TipoUbicacionController {

	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoUbicacion";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposUbicacion";
	...
	@Autowired
	public TipoUbicacionController(TipoUbicacionService tipoUbicacionService) {
		this.tipoUbicacionService = tipoUbicacionService;
	}
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoUbicacionService.readAll());		
	...
	/**
	 * Creamos una tipo de ubicación sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoUbicacionService.create());
	...
	/**
	 * Persistimos la tipo de ubicación pasado como parámetro
	...
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoUbicacionDto tipoUbicacionDto, 
	...
	public String read(@PathVariable("id") final Short id, final Model model) {
		...
		// Contenido
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoUbicacionService.read(id));
	...
	/**
	 * Preparamos la vista para la actulización del tipo de ubicación pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoUbicacionDto tipoUbicacionDto, 
			final BindingResult bindingResult, final Model model) {		
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de ubicación pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String deleteGET(@PathVariable("id") final Short id, final Model model) {
		...
		model.addAttribute(ControllerConstants.ATTRIBUTE_POPUP_ELIMINAR_PREGUNTA, 
				MessagesConstants.POPUP_ELIMINAR_TIPO_UBICACION_PREGUNTA);
	...
	/**
	 * Eliminación del tipo de ubicación pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoUbicacionService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
