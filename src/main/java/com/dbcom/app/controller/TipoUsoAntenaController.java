...
import com.dbcom.app.service.TipoUsoAntenaService;
...
@Slf4j
@Controller
public final class TipoUsoAntenaController {

	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoUsoAntena";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposUsoAntena";
	...
	private final TipoUsoAntenaService tipoUsoAntenaService;
	
	@Autowired
	public TipoUsoAntenaController(TipoUsoAntenaService tipoUsoAntenaService) {
		this.tipoUsoAntenaService = tipoUsoAntenaService;
	}
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoUsoAntenaService.readAll());		
	...
	/**
	 * Creamos una tipo de uso antena sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoUsoAntenaService.create());
	...
	/**
	 * Persistimos la tipo de uso antena pasado como parámetro
	...
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoUsoAntenaDto tipoUsoAntenaDto, 
	...
	public String read(@PathVariable("id") final Short id, final Model model) {
		...
		// Contenido
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoUsoAntenaService.read(id));
	...
	/**
	 * Preparamos la vista para la actulización del tipo de uso antena pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoUsoAntenaDto tipoUsoAntenaDto, 
			final BindingResult bindingResult, final Model model) {		
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de uso antena pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String deleteGET(@PathVariable("id") final Short id, final Model model) {
		...
		model.addAttribute(ControllerConstants.ATTRIBUTE_POPUP_ELIMINAR_PREGUNTA, 
				MessagesConstants.POPUP_ELIMINAR_TIPO_USOANTENA_PREGUNTA);
	...
	/**
	 * Eliminación del tipo de uso antena pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoUsoAntenaService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
