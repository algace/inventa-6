...
import com.dbcom.app.service.TipoRecursoOperativoService;
...
@Slf4j
@Controller
public final class TipoRecursoOperativoController {
	
	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoRecursoOperativo";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposRecursoOperativo";	
	...
	private final TipoRecursoOperativoService tipoRecursoOperativoService;
	
	@Autowired
	public TipoRecursoOperativoController(TipoRecursoOperativoService tipoRecursoOperativoService) {
		this.tipoRecursoOperativoService = tipoRecursoOperativoService;
	}
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoRecursoOperativoService.readAll());		
	...
	/**
	 * Creamos una tipo de recurso operativo sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoRecursoOperativoService.create());
	...
	/**
	 * Persistimos la tipo de recurso operativo pasado como parámetro
	...
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoRecursoOperativoDto tipoRecursoOperativoDto, 
	...
	public String read(@PathVariable("id") final Short id, final Model model) {
		...
		// Contenido
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoRecursoOperativoService.read(id));
	...
	/**
	 * Preparamos la vista para la actulización del tipo de recurso operativo pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoRecursoOperativoDto tipoRecursoOperativoDto, 
			final BindingResult bindingResult, final Model model) {		
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de recurso operativo pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String deleteGET(@PathVariable("id") final Short id, final Model model) {
		...
		model.addAttribute(ControllerConstants.ATTRIBUTE_POPUP_ELIMINAR_PREGUNTA, 
				MessagesConstants.POPUP_ELIMINAR_TIPO_RECURSOOPERATIVO_PREGUNTA);
	...
	/**
	 * Eliminación del tipo de recurso operativo pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoRecursoOperativoService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
