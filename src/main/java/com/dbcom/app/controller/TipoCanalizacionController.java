...
import com.dbcom.app.service.TipoCanalizacionService;
...
@Slf4j
@Controller
public final class TipoCanalizacionController {

	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoCanalizacion";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposCanalizacion";
	...
	private final TipoCanalizacionService tipoCanalizacionService;
	
	@Autowired
	public TipoCanalizacionController(TipoCanalizacionService tipoCanalizacionService) {
		this.tipoCanalizacionService = tipoCanalizacionService;
	}
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoCanalizacionService.readAll());		
	...
	/**
	 * Creamos una tipo de canalización sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoCanalizacionService.create());
	...
	/**
	 * Persistimos la tipo de canalización pasado como parámetro
	...
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoCanalizacionDto tipoCanalizacionDto, 
	...
	public String read(@PathVariable("id") final Short id, final Model model) {
		...
		// Contenido
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoCanalizacionService.read(id));
	...
	/**
	 * Preparamos la vista para la actulización del tipo de canalización pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoCanalizacionDto tipoCanalizacionDto, 
			final BindingResult bindingResult, final Model model) {		
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de canalización pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String deleteGET(@PathVariable("id") final Short id, final Model model) {
		...
		model.addAttribute(ControllerConstants.ATTRIBUTE_POPUP_ELIMINAR_PREGUNTA, 
				MessagesConstants.POPUP_ELIMINAR_TIPO_CANALIZACION_PREGUNTA);
	...
	/**
	 * Eliminación del tipo de canalización pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoCanalizacionService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
