...
import com.dbcom.app.service.TipoDependenciaService;
...
@Slf4j
@Controller
public final class TipoDependenciaController {
	
	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoDependencia";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposDependencia";
	...
	private final TipoDependenciaService tipoDependenciaService;
	
	@Autowired
	public TipoDependenciaController(TipoDependenciaService tipoDependenciaService) {
		this.tipoDependenciaService = tipoDependenciaService;
	}
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoDependenciaService.readAll());		
	...
	/**
	 * Creamos una tipo de dependencia sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoDependenciaService.create());
	...
	/**
	 * Persistimos la tipo de dependencia pasado como parámetro
	...
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoDependenciaDto tipoDependenciaDto, 
	...
	public String read(@PathVariable("id") final Short id, final Model model) {
		...
		// Contenido
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoDependenciaService.read(id));
	...
	/**
	 * Preparamos la vista para la actulización del tipo de dependencia pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoDependenciaDto tipoDependenciaDto, 
			final BindingResult bindingResult, final Model model) {		
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de dependencia pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String deleteGET(@PathVariable("id") final Short id, final Model model) {
		...
		model.addAttribute(ControllerConstants.ATTRIBUTE_POPUP_ELIMINAR_PREGUNTA, 
				MessagesConstants.POPUP_ELIMINAR_TIPO_DEPENDENCIA_PREGUNTA);
	...
	/**
	 * Eliminación del tipo de dependencia pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoDependenciaService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
