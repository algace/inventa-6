...
import com.dbcom.app.service.TipoUsoTiradaService;
...
@Slf4j
@Controller
public final class TipoUsoTiradaController {

	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoUsoTirada";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposUsoTirada";
	...
	private final TipoUsoTiradaService tipoUsoTiradaService;
	
	@Autowired
	public TipoUsoTiradaController(TipoUsoTiradaService tipoUsoTiradaService) {
		this.tipoUsoTiradaService = tipoUsoTiradaService;
	}
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoUsoTiradaService.readAll());		
	...
	/**
	 * Creamos una tipo de uso tirada sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoUsoTiradaService.create());
	...
	/**
	 * Persistimos la tipo de uso tirada pasado como parámetro
	...
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoUsoTiradaDto tipoUsoTiradaDto, 
	...
	public String read(@PathVariable("id") final Short id, final Model model) {
		...
		// Contenido
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoUsoTiradaService.read(id));
	...
	/**
	 * Preparamos la vista para la actulización del tipo de uso tirada pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoUsoTiradaDto tipoUsoTiradaDto, 
			final BindingResult bindingResult, final Model model) {		
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de uso tirada pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String deleteGET(@PathVariable("id") final Short id, final Model model) {
		...
		model.addAttribute(ControllerConstants.ATTRIBUTE_POPUP_ELIMINAR_PREGUNTA, 
				MessagesConstants.POPUP_ELIMINAR_TIPO_USOTIRADA_PREGUNTA);
	...
	/**
	 * Eliminación del tipo de uso tirada pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoUsoTiradaService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
