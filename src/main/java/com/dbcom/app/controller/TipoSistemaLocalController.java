...
import com.dbcom.app.service.TipoSistemaLocalService;
...
@Slf4j
@Controller
public final class TipoSistemaLocalController {

	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoSistemaLocal";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposSistemaLocal";
	...
	private final TipoSistemaLocalService tipoSistemaLocalService;
	
	@Autowired
	public TipoSistemaLocalController(TipoSistemaLocalService tipoSistemaLocalService) {
		this.tipoSistemaLocalService = tipoSistemaLocalService;
	}
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoSistemaLocalService.readAll());		
	...
	/**
	 * Creamos una tipo de sistema local sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoSistemaLocalService.create());
	...
	/**
	 * Persistimos la tipo de sistema local pasado como parámetro
	...
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoSistemaLocalDto tipoSistemaLocalDto, 
	...
	public String read(@PathVariable("id") final Short id, final Model model) {
		...
		// Contenido
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoSistemaLocalService.read(id));
	...
	/**
	 * Preparamos la vista para la actulización del tipo de sistema local pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoSistemaLocalDto tipoSistemaLocalDto, 
			final BindingResult bindingResult, final Model model) {		
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de sistema local pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String deleteGET(@PathVariable("id") final Short id, final Model model) {
		...
		model.addAttribute(ControllerConstants.ATTRIBUTE_POPUP_ELIMINAR_PREGUNTA, 
				MessagesConstants.POPUP_ELIMINAR_TIPO_SISTEMALOCAL_PREGUNTA);
	...
	/**
	 * Eliminación del tipo de sistema local pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoSistemaLocalService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
