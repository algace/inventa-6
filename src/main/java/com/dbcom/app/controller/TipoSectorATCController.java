...
@Slf4j
@Controller
public final class TipoSectorATCController {
	
	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoSectorATC";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposSectorATC";
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoSectorATCService.readAll());		
	...
	/**
	 * Creamos una tipo de sector ATC sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoSectorATCService.create());
	...
	/**
	 * Persistimos la tipo de sector ATC pasado como parámetro
	...
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoSectorATCDto tipoSectorATCDto, 
	...
	/**
	 * Preparamos la vista para la actulización del tipo de sector ATC pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoSectorATCDto tipoSectorATCDto, 
			final BindingResult bindingResult, final Model model) {		
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de sector ATC pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	/**
	 * Eliminación del tipo de sector ATC pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoSectorATCService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
