...
import com.dbcom.app.service.TipoConfiguracionRadioenlaceService;
...
@Slf4j
@Controller
public final class TipoConfiguracionRadioenlaceController {

	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoConfiguracionRadioenlace";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposConfiguracionRadioenlace";
	...
	private final TipoConfiguracionRadioenlaceService tipoConfiguracionRadioenlaceService;
	
	@Autowired
	public TipoConfiguracionRadioenlaceController(TipoConfiguracionRadioenlaceService tipoConfiguracionRadioenlaceService) {
		this.tipoConfiguracionRadioenlaceService = tipoConfiguracionRadioenlaceService;
	}
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoConfiguracionRadioenlaceService.readAll());		
	...
	/**
	 * Creamos una tipo de configuración radioenlace sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoConfiguracionRadioenlaceService.create());
	...
	/**
	 * Persistimos la tipo de configuración radioenlace pasado como parámetro
	...
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoConfiguracionRadioenlaceDto tipoConfiguracionRadioenlaceDto, 
		...
		if (bindingResult.hasErrors()) {
			...
			this.tipoConfiguracionRadioenlaceService.save(tipoConfiguracionRadioenlaceDto);
			vista = ControllerConstants.REDIRECT.concat(MAP_READALL_TIPOS);
			log.info(LoggerConstants.LOG_SAVE, tipoConfiguracionRadioenlaceDto.getId());
		}
	...
	public String read(@PathVariable("id") final Short id, final Model model) {
		...
		// Contenido
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoConfiguracionRadioenlaceService.read(id));
	...
	/**
	 * Preparamos la vista para la actulización del tipo de configuración radioenlace pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoConfiguracionRadioenlaceDto tipoConfiguracionRadioenlaceDto, 
			final BindingResult bindingResult, final Model model) {		
		...
		if (bindingResult.hasErrors()) {			
			...
			this.tipoConfiguracionRadioenlaceService.update(tipoConfiguracionRadioenlaceDto);
			vista = ControllerConstants.REDIRECT.concat(MAP_READALL_TIPOS);
			log.info(LoggerConstants.LOG_UPDATE, tipoConfiguracionRadioenlaceDto.getId());			
		}
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de configuración radioenlace pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String deleteGET(@PathVariable("id") final Short id, final Model model) {
		...
		model.addAttribute(ControllerConstants.ATTRIBUTE_POPUP_ELIMINAR_PREGUNTA, 
				MessagesConstants.POPUP_ELIMINAR_TIPO_CONFICURACIONRADIOENLACE_PREGUNTA);
	...
	/**
	 * Eliminación del tipo de configuración radioenlace pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoConfiguracionRadioenlaceService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
