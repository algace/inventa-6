...
import com.dbcom.app.service.TipoEquipoConfiguracionRadioService;
...
@Slf4j
@Controller
public final class TipoEquipoConfiguracionRadioController {
	
	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoEquipoConfiguracionRadio";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposEquipoConfiguracionRadio";		
	...
	private final TipoEquipoConfiguracionRadioService tipoEquipoConfiguracionRadioService;
	
	@Autowired
	public TipoEquipoConfiguracionRadioController(TipoEquipoConfiguracionRadioService tipoEquipoConfiguracionRadioService) {
		this.tipoEquipoConfiguracionRadioService = tipoEquipoConfiguracionRadioService;
	}
	
	/**
	 * Obtenemos un listado de los tipos de equipo configuración radio
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoEquipoConfiguracionRadioService.readAll());		
	...
	/**
	 * Creamos una tipo de equipo configuración radio sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoEquipoConfiguracionRadioService.create());
	...
	/**
	 * Persistimos la tipo de equipo configuración radio pasado como parámetro
	 * @param tipoEquipoConfiguracionRadioDto Tipo de equipo configuración radio a persistir
	 * @param bindingResult Validaciones
	 * @param model Modelo
	 * @return Vista
	 */
	@PostMapping(MAP_SAVE_TIPO)
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoEquipoConfiguracionRadioDto tipoEquipoConfiguracionRadioDto, 
	...
	/**
	 * Obtenemos el tipo de equipo configuración radio con el id facilitado
	...
	public String read(@PathVariable("id") final Short id, final Model model) {
		...
		// Contenido
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoEquipoConfiguracionRadioService.read(id));
	...
	/**
	 * Preparamos la vista para la actulización del tipo de equipo configuración radio pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	/**
	 * Actualizamos el tipo de equipo configuración radio pasado como parámetro
	 * @param tipoEquipoConfiguracionRadioDto Tipo de equipo configuración radio a actualizar
	 * @param bindingResult Validaciones
	 * @param model Modelo
	 * @return Vista
	 */
	@PostMapping(MAP_UPDATE_TIPO)
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoEquipoConfiguracionRadioDto tipoEquipoConfiguracionRadioDto, 
			final BindingResult bindingResult, final Model model) {		
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de equipo configuración radio pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String deleteGET(@PathVariable("id") final Short id, final Model model) {
		...
		model.addAttribute(ControllerConstants.ATTRIBUTE_POPUP_ELIMINAR_PREGUNTA, 
				MessagesConstants.POPUP_ELIMINAR_TIPO_EQUIPOCONFIGURACIONRADIO_PREGUNTA);
	...
	/**
	 * Eliminación del tipo de equipo configuración radio pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoEquipoConfiguracionRadioService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
