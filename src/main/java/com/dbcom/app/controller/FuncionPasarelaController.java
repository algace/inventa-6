...
@Slf4j
@Controller
public class FuncionPasarelaController {
	...
	/**
	 * Persistimos la función pasado como parámetro
	 * @param funcionPasarelaDto Función a persistir
	...
	/**
	 * Preparamos la vista para la actulización de la función pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	/**
	 * Actualizamos la función pasada como parámetro
	...
	/**
	 * Preparamos la vista para la eliminación de la función pasada como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	/**
	 * Eliminación de la función pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
