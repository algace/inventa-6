...
@Slf4j
@Controller
public class TipoUnidadFrecuenciaController {

	// Atributos de la vista
	private static final String ATTRIBUTE_TIPO = "tipoUnidadFrecuencia";

	// Vistas	
	private static final String VIEW_TIPO = ControllerConstants.MAP_PATH_MENU_TIPOS + ATTRIBUTE_TIPO;
	private static final String VIEW_TIPOS = ControllerConstants.MAP_PATH_MENU_TIPOS + "tiposUnidadFrecuencia";		
	...
	/**
	 * Obtenemos un listado de los tipos de unidad de frecuencia
	 * @param model Modelo
	 * @return Vista
	 */
	...
	public String readAll(final Model model) {
		...
		// Contenido
		model.addAttribute(ControllerConstants.ATTRIBUTE_LISTA, this.tipoUnidadFrecuenciaService.readAll());		
	...
	/**
	 * Creamos una tipo de unidad de frecuencia sin persistencia
	 * @param model modelo
	 * @return Vista
	 */
	...
	public String create(final Model model) {
		...
		// Creamos el registro
		model.addAttribute(ATTRIBUTE_TIPO, this.tipoUnidadFrecuenciaService.create());
	...
	public String save(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoUnidadFrecuenciaDto tipoUnidadFrecuenciaDto, 
		...
		if (bindingResult.hasErrors()) {
			...
			this.tipoUnidadFrecuenciaService.save(tipoUnidadFrecuenciaDto);
			vista = ControllerConstants.REDIRECT.concat(MAP_READALL_TIPOS);
			log.info(LoggerConstants.LOG_SAVE, tipoUnidadFrecuenciaDto.getId());
		}
	...
	/**
	 * Preparamos la vista para la actulización del tipo de unidad de frecuencia pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	 ...
	 * @param tipoUnidadFrecuenciaDto Tipo de unidad de frecuencia a actualizar
	 * @param bindingResult Validaciones
	 * @param model Modelo
	 * @return Vista
	 */
	@PostMapping(MAP_UPDATE_TIPO)
	public String updatePOST(@Valid @ModelAttribute(ATTRIBUTE_TIPO) final TipoUnidadFrecuenciaDto tipoUnidadFrecuenciaDto, 
			final BindingResult bindingResult, final Model model) {		
		...
		if (bindingResult.hasErrors()) {			
			...
			this.tipoUnidadFrecuenciaService.update(tipoUnidadFrecuenciaDto);
			vista = ControllerConstants.REDIRECT.concat(MAP_READALL_TIPOS);
			log.info(LoggerConstants.LOG_UPDATE, tipoUnidadFrecuenciaDto.getId());			
		}
	...
	/**
	 * Preparamos la vista para la eliminación del tipo de unidad de frecuencia pasado como parámetro
	 * @param id Identificador
	 * @param model Modelo
	 * @return Vista
	 */
	...
	/**
	 * Eliminación del tipo de unidad de frecuencia pasado como parámetro
	 * @param id Identificador
	 * @return Vista
	 */
	@PostMapping(MAP_DELETE_TIPO + "/{id}")
	public String deletePOST(@PathVariable("id") final Short id) {		
		this.tipoUnidadFrecuenciaService.delete(id);					
		log.info(LoggerConstants.LOG_DELETE);		
